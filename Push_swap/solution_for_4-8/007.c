...
void sort3(stack *A, stack *B, int len)
{
	...
	int p = 0;
	printf("\n1st while loop\n");
	while (B->lenght < len / 8) // 3/8 -> 5/8
	{
		ra = 0;
		rb = 0;
		if (A->array_of_nums[0].index >= 7 * (len / 16) && A->array_of_nums[0].index < 9 * (len / 16))
		{
			if (A->array_of_nums[0].index >= len / 2)
				rb++;
			moves += push(A, B);
	...
	printf("\n3rd while loop\n");
	while (B->lenght < 3 * (len / 8)) // 1/8 -> 7/8
	{
		ra = 0;
		rb = 0;
		if (A->array_of_nums[0].index >= 5 * (len / 16) && A->array_of_nums[0].index < 11 * (len / 16))
		{
			if (A->array_of_nums[0].index >= len / 2)
				rb++;
			moves += push(A, B);
	...
	printf("\n5th while loop\n");
	while (B->lenght < 5 * (len / 8)) // 1/8 -> 7/8
	{
		ra = 0;
		rb = 0;
		if (A->array_of_nums[0].index >= 3 * (len / 16) && A->array_of_nums[0].index < 13 * (len / 16))
		{
			if (A->array_of_nums[0].index >= len / 2)
				rb++;
			moves += push(A, B);
	...
	printf("\n7th while loop\n");
	while (B->lenght < 7 * (len / 8)) // 0 -> 1
	{
		ra = 0;
		rb = 0;
		if (A->array_of_nums[0].index >= (len / 16) && A->array_of_nums[0].index < 15 * (len / 16))
		{
			if (A->array_of_nums[0].index >= len / 2)
				rb++;
			moves += push(A, B);
