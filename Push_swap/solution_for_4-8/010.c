...
void sort3(stack *A, stack *B, int len)
{
	...
	printf("\n1st while loop\n");
	while (B->lenght < len / 9) // 3/8 -> 5/8
	{
		ra = 0;
		rb = 0;
		if (A->array_of_nums[0].index >= 4 * (len / 9) && A->array_of_nums[0].index < 5 * (len / 9))
		{
			if (A->array_of_nums[0].index >= len / 2)
				rb++;
			moves += push(A, B);
	...
	while (B->lenght < len / 3) // 3/8 -> 5/8
	{
		ra = 0;
		rb = 0;
		if (A->array_of_nums[0].index >= (len / 3) && A->array_of_nums[0].index < 2 * (len / 3))
		{
			if (A->array_of_nums[0].index >= len / 2)
				rb++;
			moves += push(A, B);
	...
	while (B->lenght < 5 * (len / 9)) // 3/8 -> 5/8
	{
		ra = 0;
		rb = 0;
		if (A->array_of_nums[0].index >= 2 * (len / 9) && A->array_of_nums[0].index < 7 * (len / 9))
		{
			if (A->array_of_nums[0].index >= len / 2)
				rb++;
			moves += push(A, B);
	...
	while (B->lenght < 7 * (len / 9)) // 3/8 -> 5/8
	{
		ra = 0;
		rb = 0;
		if (A->array_of_nums[0].index >= (len / 9) && A->array_of_nums[0].index < 8 * (len / 9))
		{
			if (A->array_of_nums[0].index >= len / 2)
				rb++;
			moves += push(A, B);
...
{
	int i;
	int const_array[] = {146, 165, 10, 298, 221, 498, 474, 7, 115, 408, 78, 425, 327, 315, 120, 158, 413, 343, 432, 457, 453, 22, 155, 142, 70, 365, 448, 407, 312, 259, 381, 193, 311, 88, 415, 287, 209, 53, 15, 124, 205, 190, 236, 224, 230, 90, 204, 264, 487, 276, 337, 210, 106, 486, 426, 159, 361, 338, 97, 42, 23, 478, 268, 240, 462, 314, 13, 174, 412, 373, 471, 245, 57, 133, 282, 424, 348, 310, 212, 36, 238, 399, 101, 183, 162, 89, 56, 234, 68, 18, 66, 41, 345, 175, 398, 313, 450, 465, 103};
